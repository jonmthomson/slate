(function() {
  ...
  function rating(el, currentRating, maxRating, callback) {
    ...
    (function init() {
      ...
      ratingDescription.classList.add('not-active');
    ...
    function starMouseOver(star) {
      star.addEventListener('mouseover', function(e) {
        ...
        ratingDescription.innerHTML = descriptionData[parseInt(star.getAttribute('data-index'))];
        ratingDescription.classList.add('is-active');
        ratingDescription.classList.remove('not-active');
      });
    }
    ...
    function starMouseOut(star) {
      star.addEventListener('mouseout', function(e) {
        ...
        ratingDescription.classList.remove('is-active');
        ratingDescription.classList.add('not-active');
      });
    }
